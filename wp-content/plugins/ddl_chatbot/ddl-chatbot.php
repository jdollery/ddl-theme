...
function add_chatbot_dialog() {
  ...
  <div class="chat__dialog chat__dialog--closed" id="chatDialog" role="dialog" aria-modal="true" aria-hidden="true"><iframe data-src="' . $chatbotScript . '" height="100%" width="100%" allow="clipboard-write *" style="border: none;"></iframe></div>
  </div>';
}
