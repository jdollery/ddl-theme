...
function render_site_description() {
  ...
  echo '<textarea style="width:700px;" name="site-description" id="site-description" class="large-text" rows="10" cols="50">' . $input . '</textarea>';
...
function render_site_phone_number() {
	...
	echo '<input style="width:500px;" type="text" id="site-phone-number" name="site-phone-number" value="' . $input . '" />';
...
function render_site_whatsapp_number() {
	...
	echo '<input style="width:500px;" type="text" id="site-whatsapp-number" name="site-whatsapp-number" value="' . $input . '" />';
...
function render_site_email_address() {
	...
	echo '<input style="width:500px;" type="email" id="site-email-address" name="site-email-address" value="' . $input . '" />';
...
function render_site_street_address() {
	...
	echo '<input style="width:500px;" type="text" id="site-street-address" name="site-street-address" value="' . $input . '" />';
...
function render_site_address_locality() {
	...
	echo '<input style="width:500px;" type="text" id="site-address-locality" name="site-address-locality" value="' . $input . '" />';
...
function render_site_address_region() {
	...
	echo '<input style="width:500px;" type="text" id="site-address-region" name="site-address-region" value="' . $input . '" />';
...
function render_site_postal_code() {
	...
	echo '<input style="width:500px;" type="text" id="site-postal-code" name="site-postal-code" value="' . $input . '" />';
...
function render_site_address_country() {
	...
	echo '<input style="width:500px;" type="text" id="site-address-country" name="site-address-country" value="' . $input . '" />';
...
function render_site_times() {
  ...
  <div class="opening" id="openingTimes">
  ...
  if (isset($repeater) && is_array($repeater)) {
      ...
      foreach ($repeater as $i => $value) {
        ...
        echo '<div class="opening__row"><input type="text" id="site-times-day" name="site-times['. $i .'][0]" placeholder="Day" value="' . esc_attr($value_day) . '" />
            ...
            <div class="remove-row">X</div></div>';
    ...
    <button type="button" class="add-a-date button-primary" data-number="<?php if ($repeater) { echo count($repeater); } else { echo '0'; } ?>">Add a date</button></div>
...
function site_options_admin_scripts() {
  wp_enqueue_script( 'site-options-script', plugin_dir_url( __FILE__ ) . '/assets/js/site-options-script.js', array( 'jquery' ), '1.0.0', true );
}
